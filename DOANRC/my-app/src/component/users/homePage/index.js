...
import Sale from "./picture/iconSale.png";
    ...
    return (
      <div id="homePage">
        ...
        <div id="wp-product">
          ...
          <div class="introduce-product introduct-one">
            <button>TOP CÁC SẢN PHẨM NỔI BẬT</button>
          </div>
          <ul id="list-product">
            <div class="product">
              <a href="thong-tin-san-pham">
                <img src={Laptop} alt="" height="150px" width="200px" />
              </a>
            ...
            <div class="product">
              ...
              <div class="price">14.000.000</div>
              <p className="sd">VNPAY - Ưu đãi tới 300.000đ</p>
              <div class="starts">
                <span>
                  <img src={Start} alt="" height="30px" width="20px" />
                </span>
