...
// import 'some-rating-plugin/dist/some-rating-plugin'; // Adjust the package name accordingly
                        ...
                        <div class="row equal">
                            ...
                            <div class="col-xs-6 col-sm-4">
                                <div class="product-container">
                                    <div class="image">
                                        <img class="img-responsive" src={Laptop} alt=""/>
                                    </div>
                                    <div class="product-meta">
                                        <h5 class="name">
                                            <a class="product-name" href="chi-tiet-san-pham.html" title="Kem làm trắng da 5 trong 1 Beaumore Secret Whitening Cream">HP 15s fq5162TU i5 1235U (7C134PA)</a>
                                        </h5>
                            ...
                            <div class="col-xs-6 col-sm-4">
                                <div class="product-container">
                                    ...
                                    <div class="product-meta">
                                        <h5 class="name">
                                            <a class="product-name" href="chi-tiet-san-pham.html" title="Kem làm sáng vùng da bikini Beaumore- 50ml">HP 15s fq5162TU i5 1235U (7C134PA)</a>
                                        </h5>
                                        <div class="product-item-price">
                            ...
                            <div class="col-xs-6 col-sm-4">
                                <div class="product-container">
                                    ...
                                    <div class="product-meta">
                                        <h5 class="name">
                                            <a class="product-name" href="chi-tiet-san-pham.html" title="Sữa rửa mặt nghệ Beaumore Mới- 100g">HP 15s fq5162TU i5 1235U (7C134PA)</a>
                                        </h5>
                                        <div class="product-item-price">
                                    ...
                                    <div class="button-product-action clearfix">
                                        <div class="cart icon">
                                            <a class="btn btn-outline-inverse buy" product-id="4" href="javascript:void(0)" title="Thêm vào giỏ">
                                            Thêm vào giỏ <i class="fa fa-shopping-cart"></i>
                                            </a>
                                        </div>
                                        <div class="quickview icon">
                            ...
                            <div class="col-xs-6 col-sm-4">
                                <div class="product-container">
                                    ...
                                    <div class="product-meta">
                                        <h5 class="name">
                                            <a class="product-name" href="chi-tiet-san-pham.html" title="Sữa tắm Sandras Mỹ chai 250ml">Sữa tắm Sandras Mỹ chai 250ml</a>
                                        </h5>
                                        <div class="product-item-price">
                                    ...
                                    <div class="button-product-action clearfix">
                                        <div class="cart icon">
                                            <a class="btn btn-outline-inverse buy" product-id="9" href="javascript:void(0)" title="Thêm vào giỏ">
                                            Thêm vào giỏ <i class="fa fa-shopping-cart"></i>
                                            </a>
                                        </div>
                                        <div class="quickview icon">
